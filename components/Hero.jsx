...
const Hero = ({ heading, message }) => {
    ...
    return (
      <div className='flex items-center justify-center h-screen bg-fixed bg-center bg-cover custom-img'>
        ...
        <div className='p-5 text-white z-[2] mt-[-5rem]'>
          ...
          <button className='px-8 py-2 rounded-lg border-2 border-orange-400 text-orange-400' onClick={handleClick}>Lähemalt</button>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className='flex items-center justify-center h-screen mb-12 bg-fixed bg-center bg-cover custom-img'>
      ...
      <div className='p-5 text-white z-[2] mt-10 mb-[-5rem]'>
